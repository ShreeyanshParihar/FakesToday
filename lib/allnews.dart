...
class _AllNewsState extends State<AllNews> {
  ...
  fetchall() async {
    ...
    final response =
        await http.get("https://www.fakestoday.com/_functions/post");
    if (response.statusCode == 200) {
      all = (json.decode(response.body) as List)
                                      ...
                                      Card(
                                        child: ListTile(
                                          leading: CachedNetworkImage(
                                            imageUrl: all[index].thumbnailUrl,
                                            fit: BoxFit.cover,
                                            height: 80.0,
                                            width: 80,
